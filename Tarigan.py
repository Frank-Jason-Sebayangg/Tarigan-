...
# Coded By @Frank Jason Sebayang
# https://www.facebook.com/frans.jason.sebayang
...
def banner():
	clear()
	wel = '# WELCOME TO MBF AREA TOOLS FRANK JASON SEBAYANG'
...
def result():
	...
	if kz in ['1','01']:
		...
		if len(vin)==0:
			...
			sol().print(mark(gerr2, style='purple'))
